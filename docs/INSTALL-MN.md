...
0.1.1 бол хөгжүүлэлтийн хувилбар. Windows installer бүтээх, суулгах, асаах,
...
3. Overlay эхлэхэд өөрөө харагдана. Өмнө нь нуугдсан бол Alt+Shift+O дарна.
4. Overlay хэсэгт өргөн/өндрийн гулсуур, байрлал, үсэг, дэвсгэрийн тунгалаг
   байдлыг тохируулна. Түгжээ тайлагдсан үед чирж байрлуулж хэмжээг өөрчилнө;
   байрлал, хэмжээ дахин асаахад хадгалагдана.
...
6. `Alt+Shift+O` харуулах/нуух, `Alt+Shift+L` click-through солих товчлол.
   ...
   Overlay олдохгүй бол **Overlay-г сэргээж харуулах** товчоор анхны хэмжээ,
   байрлал болон хулганы тохиргоог сэргээнэ.
